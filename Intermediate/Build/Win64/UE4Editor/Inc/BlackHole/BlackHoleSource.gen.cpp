...
// End Cross Module References
	DEFINE_FUNCTION(ABlackHoleSource::execMulti_PlayEffect)
	{
		P_GET_OBJECT(AActor,Z_Param_AttractedActor);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->Multi_PlayEffect_Implementation(Z_Param_AttractedActor);
		P_NATIVE_END;
	}
	static FName NAME_ABlackHoleSource_Multi_PlayEffect = FName(TEXT("Multi_PlayEffect"));
	void ABlackHoleSource::Multi_PlayEffect(AActor* AttractedActor)
	{
		BlackHoleSource_eventMulti_PlayEffect_Parms Parms;
		Parms.AttractedActor=AttractedActor;
		ProcessEvent(FindFunctionChecked(NAME_ABlackHoleSource_Multi_PlayEffect),&Parms);
	}
	...
	{
		UClass* Class = ABlackHoleSource::StaticClass();
		static const FNameNativePtrPair Funcs[] = {
			{ "Multi_PlayEffect", &ABlackHoleSource::execMulti_PlayEffect },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_ABlackHoleSource_Multi_PlayEffect_Statics
	{
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_AttractedActor;
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ABlackHoleSource_Multi_PlayEffect_Statics::NewProp_AttractedActor = { "AttractedActor", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(BlackHoleSource_eventMulti_PlayEffect_Parms, AttractedActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ABlackHoleSource_Multi_PlayEffect_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ABlackHoleSource_Multi_PlayEffect_Statics::NewProp_AttractedActor,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ABlackHoleSource_Multi_PlayEffect_Statics::Function_MetaDataParams[] = {
		{ "Comment", "//Multicast spawn effect\n" },
		{ "ModuleRelativePath", "Public/BlackHoleSource.h" },
		{ "ToolTip", "Multicast spawn effect" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ABlackHoleSource_Multi_PlayEffect_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ABlackHoleSource, nullptr, "Multi_PlayEffect", nullptr, nullptr, sizeof(BlackHoleSource_eventMulti_PlayEffect_Parms), Z_Construct_UFunction_ABlackHoleSource_Multi_PlayEffect_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ABlackHoleSource_Multi_PlayEffect_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00044CC1, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ABlackHoleSource_Multi_PlayEffect_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ABlackHoleSource_Multi_PlayEffect_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ABlackHoleSource_Multi_PlayEffect()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_ABlackHoleSource_Multi_PlayEffect_Statics::FuncParams);
		}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_GravitationalAttraction_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_GravitationalAttraction;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_SetBlackHoleEffect_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_SetBlackHoleEffect;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DestructionEffect_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_DestructionEffect;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ABlackHoleSource_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ABlackHoleSource_Multi_PlayEffect, "Multi_PlayEffect" }, // 3832805407
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABlackHoleSource_Statics::NewProp_GravitationalAttraction_MetaData[] = {
		{ "Category", "Basic Properties" },
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ABlackHoleSource_Statics::NewProp_GravitationalAttraction = { "GravitationalAttraction", nullptr, (EPropertyFlags)0x0011000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABlackHoleSource, GravitationalAttraction), METADATA_PARAMS(Z_Construct_UClass_ABlackHoleSource_Statics::NewProp_GravitationalAttraction_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABlackHoleSource_Statics::NewProp_GravitationalAttraction_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABlackHoleSource_Statics::NewProp_SetBlackHoleEffect_MetaData[] = {
		{ "Category", "Basic Properties|Effects" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ABlackHoleSource_Statics::NewProp_SetBlackHoleEffect = { "SetBlackHoleEffect", nullptr, (EPropertyFlags)0x0011000000000005, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABlackHoleSource, SetBlackHoleEffect), Z_Construct_UClass_UParticleSystem_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ABlackHoleSource_Statics::NewProp_SetBlackHoleEffect_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABlackHoleSource_Statics::NewProp_SetBlackHoleEffect_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABlackHoleSource_Statics::NewProp_DestructionEffect_MetaData[] = {
		{ "Category", "Basic Properties|Effects" },
		{ "Comment", "// Black hole particle effect\n" },
		{ "ExposeOnSpawn", "true" },
		{ "ModuleRelativePath", "Public/BlackHoleSource.h" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ABlackHoleSource_Statics::NewProp_DestructionEffect = { "DestructionEffect", nullptr, (EPropertyFlags)0x0011000000000005, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABlackHoleSource, DestructionEffect), Z_Construct_UClass_UParticleSystem_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ABlackHoleSource_Statics::NewProp_DestructionEffect_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABlackHoleSource_Statics::NewProp_DestructionEffect_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABlackHoleSource_Statics::NewProp_DestructionSound_MetaData[] = {
		{ "Category", "Basic Properties|Sounds" },
		{ "Comment", "// Black hole sound\n" },
		{ "ExposeOnSpawn", "true" },
		{ "ModuleRelativePath", "Public/BlackHoleSource.h" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ABlackHoleSource_Statics::NewProp_DestructionSound = { "DestructionSound", nullptr, (EPropertyFlags)0x0011000000000005, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABlackHoleSource, DestructionSound), Z_Construct_UClass_USoundBase_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ABlackHoleSource_Statics::NewProp_DestructionSound_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABlackHoleSource_Statics::NewProp_DestructionSound_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ABlackHoleSource_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABlackHoleSource_Statics::NewProp_GravitationalAttraction,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABlackHoleSource_Statics::NewProp_BlackHoleMesh,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABlackHoleSource_Statics::NewProp_SetBlackHoleEffect,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABlackHoleSource_Statics::NewProp_DestructionEffect,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABlackHoleSource_Statics::NewProp_DestructionSound,
	};
	...
	IMPLEMENT_CLASS(ABlackHoleSource, 642636487);
